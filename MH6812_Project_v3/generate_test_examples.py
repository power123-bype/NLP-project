...
style_map = {
        ...
        "cold":   "Cool down the image significantly. Remove the yellow and golden tint completely. Make the snow look white and cold.",
        "bright": "Significantly decrease the brightness to recover details in the overexposed sky. Make the image look more balanced and less blinding.",
        ...
        "road":   "Maximize exposure and brightness to simulate bright daylight. Keep the color temperature cool and neutral, strictly avoiding any red or orange tint."
    }
